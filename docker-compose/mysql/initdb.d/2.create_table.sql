...
(
    ...
    board_name               NVARCHAR(20) NOT NULL,
    board_description        NVARCHAR(50) NULL,
...
(
    ...
    memo_content NVARCHAR(100) NOT NULL,
    primary key (memo_id)
);
...
(
    ...
    board_theme_name             NVARCHAR(20) NOT NULL,
    ...
    board_theme_font             NVARCHAR(20) NULL,
...
(
    ...
    theme_category_name NVARCHAR(50) NOT NULL,
...
(
    ...
    image_original_name NVARCHAR(255) NOT NULL,
    image_saved_name    NVARCHAR(255) NOT NULL,
